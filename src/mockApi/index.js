export default {
  ...
  stacks: [
    {
      ...
      description: 'Proficient in builing robust and scalable REST & GraphQL APIs. Skilled in building APIs and web backend with python Django & Flask. Currently leveling up on building backend APIs with RubyOnRails 5.'
    },
    {
      id: 2,
  ...
  userInfo: {
    ...
    name: 'Daniel Kamar',
    bio:
      'Daniel Kamar is a self-motivated and goal oriented individual with the ability to follow through with projects from inception to completion using analytical and problem-solving skills.'
  },
  stories: {
    experiences: [
      {
        id: 4,
        title: 'Software Engineer',
        timeline: 'Mar 2019 – Present • 7 mos',
        company: 'Andela',
        description:
      ...
      },
      {
        id: 3,
        title: 'Software Tech',
        timeline: 'Nov 2015 – Feb 2019 • 1 yrs 8 mos',
      ...
      },
      {
        id: 2,
        title: 'Techpreneur',
        timeline: 'Mar 2014 – Oct 2015 • 1 yrs 8 mos',
      ...
      {
        id: 1,
        title: 'Managing IT Specialist',
        timeline: 'Jan 2015 – Sep 2015 • 9 mos',
        company: 'Idyll Cyber & Information Centre',
        description: `Responsibilities <br />
      <ul>
